...
public class SetInstanceHealthWorker
        extends
        AbstractWorker<SetInstanceHealthRequestMessage, SetInstanceHealthResultMessage> {
    private final Logger logger = Appctx
            .getLogger(SetInstanceHealthWorker.class.getName());
    ...
    @Override
    @Transactional
    protected SetInstanceHealthResultMessage doWork0(
            SetInstanceHealthRequestMessage req, ServiceRequestContext context)
            throws Exception {

        final SetInstanceHealthResultMessage.Builder result = SetInstanceHealthResultMessage
                .newBuilder();
