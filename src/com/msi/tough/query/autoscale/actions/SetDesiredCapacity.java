...
public class SetDesiredCapacity extends AbstractAction<Object> {
	...
	public Object process0(final Session session, final HttpServletRequest req,
			...
			throws Exception {
		final SetDesiredCapacityRequest r = SetDesiredCapacityRequestUnmarshaller
		...
		if (r.getDesiredCapacity() < 0) {
			throw AutoScaleQueryFaults.desiredCapacityNegative(r
					.getDesiredCapacity());
		}
		en.setCapacity(r.getDesiredCapacity());
		session.save(en);
		return null;
	}
}
